...
export default class CustomLayout4 extends Component {
  static displayName = 'CustomLayout4';
  ...
  render() {
    ...
    return (
      ...
      >
        <Header
          className={cx({
            'ice-custom-layout4-header': true,
          })}
          theme={theme}
        ...
        <Layout.Section
          className={cx({
            'ice-custom-layout4-main-section': true,
            'ice-custom-layout4-main-section-open-drawer': this.state
              .openDrawer,
            'ice-custom-layout4-main-section-collapse': this.state.collapse,
          })}
        >
        ...
        <Footer
          className={cx({
            'ice-custom-layout4-footer': true,
          })}
        />
      </Layout>
    );
